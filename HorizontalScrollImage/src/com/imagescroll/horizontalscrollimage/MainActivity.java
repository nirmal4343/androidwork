...
public class MainActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dataList.add(new DrawerItem("Message", R.drawable.ic_messages));
		...
		mSectionsPagerAdapter = new HorizontalScrollImageAdapter(
	...
	public void SelectItem(int position) {
		...
		switch (position) {
		case 2:
			Intent a = new Intent(MainActivity.this, MessageInboxActivity.class);
			startActivity(a);
			break;
