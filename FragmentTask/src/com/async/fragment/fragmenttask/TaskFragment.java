package com.async.fragment.fragmenttask;

import com.async.fragment.fragmenttask.RestClient.RequestMethod;
...
public class TaskFragment extends Fragment {
	...
	private static final String REST_URL = "http://learnresfull-restcall.rhcloud.com/restaurent/";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// It is important to set this flag "true" to keep the task working in the background
		// and later sync it back to the activity with the data.  This will be helpful to avoid any Configuration change.
	...
	private class DummyTask extends AsyncTask<Void, Integer, String> {
		...
		protected String doInBackground(Void... ignore) {
			...
			RestClient client = new RestClient(REST_URL);
