...
public class MainActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			mProgressBar.setProgress(savedInstanceState
					.getInt(KEY_CURRENT_PROGRESS));
	...
	public void onPreExecute() {
		...
		mButton.setText(getString(R.string.cancel));
		Toast.makeText(this, R.string.task_started_msg, Toast.LENGTH_SHORT)
				.show();
	}
	...
	public void onPostExecute(String response) {
		...
		Toast.makeText(this, R.string.task_complete_msg, Toast.LENGTH_SHORT)
				.show();
	}
